...
distclean: clean
	...
	@find -type f \( -name xmeformat -o -name xmbuildinfo -o -name xmpack -o -name xmcparser -o -name xmcpartcheck -o -name xmccheck -o -name xmproject -o -name xmgcov \) -exec rm '{}' \;
