...
/*
  ...
  - [18/02/2016:SPR-180216-02] AlignedMemCpy added
*/
...
static inline void AlignedMemCpy(xm_u8_t *dst, xm_u8_t *src, xmSSize_t size, RdMem_t SrcR, RdMem_t DstR, WrMem_t DstW)
{
    xm_s32_t e;
    xmWord_t cpWord;
    for(e = 0; e < size; e += sizeof(xmWord_t))
    {
        cpWord = SrcR((xm_u32_t *) (src + e));
        DstW((xm_u32_t *) (dst + e), cpWord);
    }
}
extern xm_u64_t DivMod64(xm_u64_t numer, xm_u64_t denom, xm_u64_t *remain);
